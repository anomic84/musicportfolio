...
const About = () => {
    return (
        <div className="bg-slate-900 pt-5 pb-14" id="about">
            ...
            <div className="flex flex-col ">
                <div className="px-[17px] max-w-[960px] mx-auto">
                    ...
                    <p className="text-[6px] md:text-[8px] font-ubuntu text-navtext">Picture taken by <a className="text-[8px] md:text-[10px]  text-navnametext cursor-pointer " href="https://flickr.com/photos/115479516@N05?fbclid=IwAR1Jao9SkkKj249IZObK41ujkspADim5eiUDsMvL5mYjPEWte80HqrpUUgw">
                ...
                <div className="inline-grid grid-cols-2 lg:grid-cols-4 gap-[5px] px-[17px] py-[5px] mx-auto max-w-[960px]">
                    ...
                    <div>
                        ...
                        <p className="hidden lg:block text-[6px] font-ubuntu text-navtext">Picture taken by <a className="text-[10px]  text-navnametext cursor-pointer " href="https://flickr.com/photos/115479516@N05?fbclid=IwAR1Jao9SkkKj249IZObK41ujkspADim5eiUDsMvL5mYjPEWte80HqrpUUgw">
                            Andrew Kvenvolden</a></p>
                    </div>
                </div>
                {/* for tablets and mobile */}
                <ol className="px-[17px] flex  m-auto whitespace-wrap items-center lg:hidden">
                    <li className="text-[6px] md:text-[8px] px-1  font-ubuntu text-navtext">Pictures 1 & 2 taken by <span className="text-[6px] md:text-[10px] text-navnametext cursor-pointer">James Toohey</span></li>
                    <li className="text-[6px] md:text-[8px] px-1  font-ubuntu text-navtext">Picture 3 taken by <a className="text-[6px] md:text-[10px] text-navnametext cursor-pointer" href="http://www.iamwonder.net/?fbclid=IwAR1LYKKFhxS4Ny5NrdxQgtJHvtMGc0xCRmPH4nn-48V-tPNFoWVHVPo9Uzs">
                        Wonder Wood</a></li>
                    <li className="text-[6px] md:text-[8px] px-1  font-ubuntu text-navtext">Picture 4 taken by <a className="text-[6px] md:text-[10px] text-navnametext cursor-pointer " href="https://flickr.com/photos/115479516@N05?fbclid=IwAR1Jao9SkkKj249IZObK41ujkspADim5eiUDsMvL5mYjPEWte80HqrpUUgw">
