...
const Busride = () => {
  return (
    <section className="bg-navnametext py-10" id="busride">
      <div>
        <h1 className='text-center font-bungee text-aboutbg text-5xl px-[17px] pb-3'>Bus Ride <br className='md:hidden' />Daydream</h1>
      </div>
      {/* <div class>
      ...
      <div className='flex flex-col sm:flex-row sm:flex-wrap items-center justify-center py-4 bg-navnametext'>
