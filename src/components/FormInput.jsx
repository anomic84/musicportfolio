...
const FormInput = (props) => {
    ...
    return (
        <div className='w-[90%] md:w-[80%] lg:w-[65%] max-w-[1024px] mx-auto flex flex-col py-2'>
            ...
            <span className='text-xs text-aboutbg font-ubuntu font-semibold mt-2 error'>{errorMessage}</span>
        </div>
    )
}
